...
const GAME_MINUTE_DURATION: float = TAU / MINUTES_PER_DAY # Pdkt, 2 di kalikan degan PI di bagi menit perhari
...
signal time_tick(day: int, hour: int, munite: int)
